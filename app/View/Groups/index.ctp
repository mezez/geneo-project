		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($groups as $group): ?>
					<tr>
						<td nowrap><?php echo h($group['Group']['id']); ?>&nbsp;</td>
						<td nowrap><?php echo h($group['Group']['name']); ?>&nbsp;</td>
						<td nowrap><?php echo h($group['Group']['created']); ?>&nbsp;</td>
						<td nowrap><?php echo h($group['Group']['modified']); ?>&nbsp;</td>
						<td class="actions">
