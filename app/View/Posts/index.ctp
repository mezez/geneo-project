        ...
        <div class="col-md-9">
            <table cellpadding="0" cellspacing="0" class="table table-striped">
                ...
                <tr>
                    ...
                    <!--						<th nowrap>-->
                    <?php //echo $this->Paginator->sort('body'); ?><!--</th>-->
                ...
                <?php foreach ($posts as $post): ?>
                    <tr>
                        ...
                        <!--						<td nowrap>-->
                        <?php //echo h($post['Post']['body']); ?><!--&nbsp;</td>-->
                        <td nowrap><?php echo h($post['Post']['created']); ?>&nbsp;</td>
                        <td nowrap><?php echo h($post['Post']['modified']) ? h($post['Post']['modified']) : "Not Available"; ?>
                            &nbsp;</td>
                        ...
                        <td class="actions">
                            ...
                            <?php
                            if ($role == 'admin' || $post['Post']['user_id'] == $userId) {
                                echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $post['Post']['id']), array('escape' => false));
                            }
                            ?>
                            <?php if ($role == 'admin' || $post['Post']['user_id'] == $userId) {
                                echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $post['Post']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $post['Post']['id']));
                            }
                            ?>
                        </td>
                    </tr>
